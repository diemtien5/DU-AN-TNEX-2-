    ...
    <main className="min-h-screen bg-gradient-to-b from-background to-slate-50">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Button className="bg-green-500 hover:bg-green-600 text-white">Đăng ký ngay</Button>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4">
            <h1 className="text-2xl md:text-5xl font-bold text-slate-900 leading-tight">
              <span className="text-green-600">Dự án Tnex TSA 1-1</span>
            </h1>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-8 md:py-24">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-gradient-to-br from-green-50 to-slate-50 rounded-2xl p-6 border border-green-200">
                ...
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  ...
                  <div className="bg-white rounded-lg p-3 border border-green-300">
                    <a 
                      ...
                      className="group relative inline-flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 zalo-float"
                    >
                      {/* Zalo Icon */}
                      <svg 
                      ...
                      {/* Wave Effect Layer 1 */}
                      <div className="absolute inset-0 rounded-full bg-green-400 opacity-0 group-hover:opacity-60 group-hover:zalo-wave-1 transition-opacity duration-500"></div>
                      
                      {/* Wave Effect Layer 2 */}
                      <div className="absolute inset-0 rounded-full bg-green-300 opacity-0 group-hover:opacity-40 group-hover:zalo-wave-2 transition-opacity duration-700"></div>
                      
                      {/* Wave Effect Layer 3 */}
                      <div className="absolute inset-0 rounded-full bg-green-200 opacity-0 group-hover:opacity-30 group-hover:zalo-wave-3 transition-opacity duration-1000"></div>
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-green-50 to-slate-50 rounded-lg p-4 border border-green-200">
                  ...
                  <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-6 border border-green-300 flex flex-col items-center text-white">
                    <h5 className="text-base font-bold mb-1">QR tra cứu thông tin</h5>
                    <p className="text-green-100 text-xs mb-3">Đưa mã này cho khách hàng</p>
                    <div className="bg-white rounded-lg p-3 mb-2">
                      <img src="/qr-code-customer.png" alt="QR Code tra cứu thông tin cho khách hàng" className="w-32 h-32" />
                    </div>
                    <p className="text-green-100 text-xs text-center mb-2">Mã QR tra cứu thông tin dành cho khách hàng</p>
                    <p className="text-green-200 text-xs text-center mb-2">Mã CTV: CTV1679</p>
                    <QRDownloadButton />
                  </div>
                </div>
              </div>
